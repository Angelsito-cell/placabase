# La Placa Base: Evolución, Formatos y Componentes
...
Ahora y por último, voy a analizar la mayor parte de los componentes importantes de la placa base

### 1- El socket de CPU 

Lugar donde se coloca el procesador. Su diseño varía según la marca y el modelo, como los sockets AM5 de AMD o los LGA1700 de Intel, que son específicos para cada tipo de procesador.

![Pin page](https://upload.wikimedia.org/wikipedia/commons/7/79/LGA_Socket_1366.jpg)

### 2- Las ranuras de RAM 

Son los espacios donde se instala la memoria del sistema. La cantidad y el tipo de memoria, como DDR4 o DDR5, dependen de la placa base, lo que afecta tanto la capacidad como la velocidad del equipo.

![Pin page](https://www.profesionalreview.com/wp-content/uploads/2020/05/DDR3-slot-memoria-RAM-scaled.jpg)

### 3- El chipset 

Actúa como el controlador principal de la placa base, gestionando la comunicación entre la CPU, la memoria, el almacenamiento y los dispositivos externos. Tanto Intel como AMD desarrollan chipsets específicos para optimizar sus procesadores.

![Pin page](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGs2hjjDRscjxbZLtgtmhRPtmv21sDTNDdrA&s)

### 4- Las ranuras PCIe (Peripheral Component Interconnect Express) 

Son utilizadas para tarjetas de expansión como las tarjetas gráficas (GPU), de red o unidades de almacenamiento. Las versiones más actuales, como PCIe 4.0 y 5.0, ofrecen un ancho de banda mucho mayor.

![Pin page](https://hardzone.es/app/uploads-hardzone.es/2019/12/placa-pc.jpg)

### 5- Los conectores para almacenamiento 

Incluyen interfaces M.2 y SATA. M.2 permite velocidades mucho más rápidas en comparación con SATA, lo que mejora considerablemente el rendimiento del sistema.

![Pin page](https://www.ticarte.com/sites/su/users/7/image/conector_fdd.jpg)

### 6- Los puertos USB 

Sirven para conectar dispositivos externos, como ratones, teclados y discos duros. Los USB 3.0 y USB-C son versiones más rápidas y avanzadas, capaces de transferir datos a mayores velocidades.

![Pin page](https://www.profesionalreview.com/wp-content/uploads/2020/09/C%C3%B3mo-solucionar-velocidad-usb-5.jpg)

### 7 - El BIOS/UEFI 

Es el software que se ejecuta al iniciar el sistema, permitiendo configuraciones del hardware antes de cargar el sistema operativo. UEFI es la evolución de BIOS, con más funcionalidades y una interfaz más moderna.

![Pin page](https://hardzone.es/app/uploads-hardzone.es/2020/06/Portada-BIOS.jpg)

### 8- Los conectores de alimentación 

Proveen energía tanto a la placa base como a la CPU. El conector principal es de 24 pines (ATX), mientras que la CPU a menudo requiere conectores adicionales de 4 u 8 pines.

![Pin page](https://acf.geeknetic.es/imgw/imagenes/auto/2022/1/27/k8w-conectoresplacasbase.jpg?f=webp)

### 9- El chip de red (LAN o Wi-Fi) 

Es el encargado de las conexiones a internet. Algunas placas base tienen puertos Ethernet integrados, mientras que otras incluyen conectividad inalámbrica como Wi-Fi y Bluetooth.

![Pin page](https://img.pccomponentes.com/pcblog/8835/chipset-placa-base-que-es.jpg)

### 10- Los conectores de audio

Manejan tanto las entradas como las salidas de sonido. Suelen contar con chips como Realtek, que ofrecen audio de alta calidad para micrófonos, auriculares y altavoces.

![Pin page](https://hardzone.es/app/uploads-hardzone.es/2023/09/conectores-audio-pc-1.jpg)

### 11- La batería CMOS 

Es la encargada de mantener la configuración de la BIOS y la hora del sistema cuando la computadora está apagada, alimentando la memoria CMOS.

![Pin page](https://www.shutterstock.com/image-photo/cmos-backup-battery-powering-bios-600nw-1899299680.jpg)

### 12- Los disipadores y conectores para ventiladores 

Permiten enfriar los componentes más importantes como la CPU o las unidades de almacenamiento M.2, y muchas placas incluyen conectores para sistemas de refrigeración avanzados, como la refrigeración líquida.

![Pin page](https://cdn.computerhoy.com/sites/navi.axelspringer.es/public/media/image/2023/12/cpu-fan-cpu-opt-son-sirven-diferencian-placa-base-3253096.jpg?tf=3840x)
